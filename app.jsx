...
{n:1,d:"28/05",dow:"Gio",c:"Tokyo",j:"東京",p:1,sl:"✅ Plat Hostel Keikyu Asakusa Karin — 34,85€ 2 notti",
 ...
 schedule:[
   {id:1,time:"09:10",txt:"✈️ Atterraggio Narita · 7-Bank ATM Yen · Welcome Suica Apple Pay"},
   {id:2,time:"10:30",txt:"🚨 Keisei Access Express (Skyaccess) → Asakusa diretto 1h · Check-in Plat Hostel"},
   {id:3,time:"13:30",txt:"⛩️ Sensō-ji · quaderno Goshuin · 💡 Asakusa Kagetsudo: Jumbo Melonpan caldo croccante"},
   {id:4,time:"15:00",txt:"🎌 Ochanomizu ponte Hijiribashi · 📸 3 treni contemporanei su 3 livelli (aspetta!)"},
   {id:5,time:"16:30",txt:"🎌 Yotsuya Suga Shrine Otokozaka · 🌅 Luce 17:00 perfetta Your Name vibe"},
   {id:6,time:"18:15",txt:"🥢 Tsukishima Monja Street · ordina Monjayaki con piastra (test giapponese!)"},
   {id:7,time:"20:00",txt:"✅ TeamLab Planets Toyosu · 💡 Piedi nudi · acqua 50cm · pantaloni arrotolabili"},
 ],exp:[]},
...
{n:2,d:"29/05",dow:"Ven",c:"Tokyo",j:"東京",p:1,sl:"✅ Plat Hostel Keikyu Asakusa Karin (stessa prenotazione)",
 ...
 schedule:[
   {id:1,time:"08:00",txt:"🐟 Tsukiji Outer Market · sushi fresco, Tamagoyaki, ostriche"},
   {id:2,time:"09:15",txt:"🚇 Spostamento verso Shibuya"},
   {id:3,time:"10:00",txt:"🏙️ Shibuya Sky · vista mattutina cielo limpido pazzesco"},
   {id:4,time:"12:00",txt:"🚇 Spostamento verso Nakano · Yamanote → Shinjuku → Chuo Line (comodo!)"},
   {id:5,time:"12:30",txt:"🛍️ Nakano Broadway · pranzo al volo galleria Sun Mall · immersione Mandarake"},
   {id:6,time:"15:00",txt:"🚇 Rientro in zona Cafe Capyba"},
   {id:7,time:"16:00",txt:"🐾 Cafe Capyba · relax totale"},
   {id:8,time:"17:30",txt:"🛍️ Akihabara sera · neon illuminati · sale giochi pieno ritmo · SURUGA-YA, TRADER · rhythm game"},
 ],exp:[]},
...
{n:3,d:"30/05",dow:"Sab",c:"Tokyo → Nikkō",j:"東京→日光",p:1,sl:"✅ Guest House KITOEDA — Nikkō · 28€",
 ...
 schedule:[
   {id:1,time:"07:30",txt:"🚃 Tobu Limited Express Kegon da Asakusa · 💡 Biglietti Tōshō-gū alla stazione arrivo!"},
   {id:2,time:"09:30",txt:"Arrivo Nikkō · deposito bagagli KITOEDA · 🎫 Chuzenji Onsen Free Pass 2000¥ (Fermata 1-31)"},
   {id:3,time:"10:00",txt:"🌉 Shinkyo Bridge · ponte rosso sacro Futarasan · foto veloce salendo a piedi"},
   {id:4,time:"10:30",txt:"⛩️ Tōshō-gū · Tre Scimmiette, Elefanti Immaginati, Gatto Dormiente Nemuri Neko"},
   {id:5,time:"11:30",txt:"🧗 SPOT NASCOSTO: Inner Shrine · 200+ gradini tra cedri · atmosfera mistica lontano da folla"},
   {id:6,time:"13:30",txt:"🚌 Bus Okunikko → Cascata Kegon · 💡 Ascensore a pagamento (4$) per piattaforma base"},
   {id:7,time:"16:00",txt:"🐉 Ryuzu Falls · 📸 Scalinate lungo fiume per prospettive alternative meno affollate"},
   {id:8,time:"18:00",txt:"🎆 Verifica eventi serali: Light-up Nikko al Futarasan o Rinno-ji (bancarelle + Goshuin speciali)"},
 ],exp:[]},
...
{n:4,d:"31/05",dow:"Dom",c:"Nikkō → Aizu → Fukushima",j:"日光→会津→福島",p:1,sl:"✅ YUMORI ONSEN HOSTEL — con onsen integrato ♨️",
 ...
 schedule:[
   {id:1,time:"08:00",txt:"🚆 Nikkō → Utsunomiya → Kōriyama → Aizu · 💡 JR Pass: Shinkansen tratta Utsunomiya-Kōriyama!"},
   {id:2,time:"11:30",txt:"Arrivo Aizu-Wakamatsu · coin locker · 🚌 Bus turistici Haikara-san/Akabe (fermano a Sazaedo e castello)"},
   {id:3,time:"12:00",txt:"🌀 Sazaedo Temple Monte Iimori · doppia elica legno · 🎌 Byakkotai (Tigri Bianche 16-17 anni seppuku)"},
   {id:4,time:"13:30",txt:"🥢 Sauce Katsudon · versione Aizu con cotoletta enorme e salsa densa dolce-salata su cavolo"},
   {id:5,time:"14:30",txt:"🏯 Tsuruga-jo · unico castello tegole rosse · 🍵 Sala tè Rinkaku tra pini (matcha + dolcetto · 20min relax)"},
   {id:6,time:"17:00",txt:"🚆 Treno Fukushima (via Kōriyama) · check-in YUMORI ONSEN HOSTEL"},
   {id:7,time:"19:00",txt:"♨️ Relax onsen integrato · lava via 4h treno · atmosfera rilassata · chiacchiere viaggiatori"},
 ],exp:[]},
...
{n:5,d:"01/06",dow:"Lun",c:"Fukushima → Sendai",j:"福島→仙台",p:1,sl:"Sendai Guest House Umebachi",
 ...
 schedule:[
   {id:1,time:"08:30",txt:"🚆 Fukushima → Shiroishi-Zao · 💡 JR Pass: Shinkansen Yamabiko 15min (vs 30min locale)"},
   {id:2,time:"09:30",txt:"🦊 Zao Fox Village · 🚨 Taxi sharing 4000¥ (cerca turisti in stazione!) · Regole: no abbassarsi/accarezzare"},
   {id:3,time:"12:00",txt:"🚆 Rientro Sendai · check-in Guest House Umebachi"},
   {id:4,time:"14:00",txt:"🌳 Jozenji-dori viale alberato · 🍡 Zunda Shake (edamame dolce) ovunque in centro!"},
   {id:5,time:"16:00",txt:"🏯 Castello Aoba (Loople Sendai bus) · 📸 Statua equestre Date Masamune · vista Sendai-oceano"},
   {id:6,time:"18:30",txt:"🐮 Gyutan da Kisuke/Rikyu · set completo: lingua spessa + zuppa coda bue + riso orzo"},
   {id:7,time:"20:30",txt:"🍻 Kokubuncho distretto vita notturna · izakaya per chiudere serata"},
 ],exp:[]},
...
{n:6,d:"02/06",dow:"Mar",c:"Sendai (Yamadera day trip)",j:"仙台(山寺日帰り)",p:1,sl:"Sendai Guest House Umebachi",
 ...
 schedule:[
   {id:1,time:"08:00",txt:"🎒 Zaino leggero · bagaglio in ostello · 🚨 Gore-Tex (Tsuyu!) + quaderno Goshuin"},
   {id:2,time:"08:30",txt:"🚃 Senzan Line Sendai → Yamadera 1h · boschi Ghibli vibe foschia"},
   {id:3,time:"09:30",txt:"⛩️ 1015 gradini cedri sacri · muschio verde brillante · ritmo costante umidità +30%"},
   {id:4,time:"10:30",txt:"🧗 Midanidokoro masso Buddha · passo senza strappare"},
   {id:5,time:"11:30",txt:"🌅 Cima Gododō tempio sospeso · vista vallata · haiku Matsuo Bashō · silenzio spettrale"},
   {id:6,time:"13:00",txt:"🍜 Pranzo base: Yamadera Chikara Soba (mochi energia) + Tama Konnyaku (konjac senape)"},
   {id:7,time:"14:00",txt:"🚃 Senzan Line rientro Sendai"},
   {id:8,time:"15:30",txt:"🚇 Sendai Daikannon quartiere Izumi · statua bianca 100m come mech titanico tra palazzi"},
   {id:9,time:"18:00",txt:"🏙️ AER Building 31° piano osservatorio GRATIS · tramonto Sendai che si accende"},
   {id:10,time:"19:00",txt:"🥢 Cena lenta: Gyutan da Rikyu · set completo senza frenesia"},
   {id:11,time:"20:30",txt:"🚶 Jozenji-dori notturna · luci tra zelkova · atmosfera cinematografica malinconica"},
   {id:12,time:"21:30",txt:"🍸 Bar K speakeasy Kokubuncho · legno scuro · bartender completi 3 pezzi eleganza · whisky giapponese · keigo"},
   {id:13,time:"23:00",txt:"📓 Rientro ostello · doccia · appunti diario"},
 ],exp:[]},
...
{n:7,d:"03/06",dow:"Mer",c:"Sendai (Matsushima day trip)",j:"仙台(松島日帰り)",p:1,sl:"Sendai Guest House Umebachi",
 ...
 schedule:[
   {id:1,time:"09:00",txt:"🚃 Senseki Line Sendai → Matsushima-Kaigan (40min locale)"},
   {id:2,time:"09:45",txt:"🚢 Crociera baia · centinaia isole coperte pini = bonsai giganti in mare"},
   {id:3,time:"11:00",txt:"🍵 Kanrantei casa da tè storica (Toyotomi → Date Masamune) · matcha tatami vista baia"},
   {id:4,time:"11:45",txt:"🌉 Fukuura Bridge rosso 252m · leggenda: fortuna incontri importanti vita"},
   {id:5,time:"12:30",txt:"⛩️ Zuigan-ji tempio zen roccia + Entsu-in · giardino muschio · mausoleo motivi occidentali 1600 (picche cuori rose oro!)"},
   {id:6,time:"14:00",txt:"🦪 Kaki Goya pranzo · ostriche grigliate enormi fresche · all-you-can-eat a tempo!"},
   {id:7,time:"15:30",txt:"🚃 Senseki Line rientro Sendai"},
   {id:8,time:"16:30",txt:"🏃‍♂️ Scarico fiume Hirosegawa · corsa tramonto · defaticamento post-Yamadera · aria perfetta"},
   {id:9,time:"18:30",txt:"🥢 Cena: Seri Nabe hot-pot · prezzemolo giapponese locale · mangiato intero con radici croccanti"},
   {id:10,time:"20:30",txt:"📚 Maruzen AER Building o Tsutaya · artbook nicchia · doujinshi · referenze Substack"},
   {id:11,time:"22:00",txt:"🏠 Rientro Umebachi · 📦 PREP BAGAGLIO GRANDE: domani Takkyubin → Kanazawa!"},
 ],exp:[]},
...
{n:8,d:"04/06",dow:"Gio",c:"Sendai → Morioka",j:"仙台→盛岡",p:1,sl:"Ostello Morioka",
 ...
 schedule:[
   {id:1,time:"08:30",txt:"📦 Takkyubin valigia 20kg → Kanazawa · konbini (7-Eleven/FamilyMart) o reception · denpyo pratica giapponese!"},
   {id:2,time:"09:30",txt:"🚄 Shinkansen Hayabusa Sendai → Morioka 50min · 🚨 Posti prenotati! Biglietto JR Pass con posto assegnato"},
   {id:3,time:"10:30",txt:"🎒 Arrivo Morioka · check-in ostello o coin locker zaino"},
   {id:4,time:"11:00",txt:"🌸 Ishiwarizakura ciliegio spacca-roccia granito · radici potenti incastrate pietra"},
   {id:5,time:"12:00",txt:"🍡 Konzaya negozio miso/soia storico edificio secolare · aroma fermentazione intenso"},
   {id:6,time:"13:00",txt:"🍜 WANKO SOBA CHALLENGE Azumaya · obiettivo 100+ ciotoline · 🏃‍♂️ Strategia: ritmo costante come 800m · NO strappo · NON bere brodo!"},
   {id:7,time:"15:00",txt:"🏯 Morioka Castle Ruins Park digestione · mura granito muschio rilassanti · smaltire 100+ ciotole"},
   {id:8,time:"16:30",txt:"🏛️ Bank of Iwate Red Brick 1911 · architetti Stazione Tokyo · sala sportelli legni stucchi notevoli"},
   {id:9,time:"18:30",txt:"🍜 Cena leggera: Morioka Reimen Seiroukaku/Pyonpyonsha · noodle freddi elastici · brodo manzo kimchi uovo · 🍉 anguria/mela!"},
   {id:10,time:"20:30",txt:"🛏️ Rientro ostello · prep gambe: domani Lago Tazawa sotto pioggia Tsuyu"},
 ],exp:[]},
...
{n:9,d:"05/06",dow:"Ven",c:"Morioka → Tazawa Lake",j:"盛岡→田沢湖",p:1,sl:"✅ Katakurinohana — 86€ · Booking #655173907",
 ...
 schedule:[
   {id:1,time:"08:00",txt:"🚄 Shinkansen Komachi ROSSO FUOCO Morioka → Tazawako 40min · si stacca da Hayabusa verde · zaino leggero!"},
   {id:2,time:"09:00",txt:"🎒 Arrivo · check-in Katakurinohana (o drop zaino se non pronta) · vicino lago"},
   {id:3,time:"09:30",txt:"🏃 RUN 1: Giro Lago Tazawa 20.4km · più profondo Giappone · blu indaco irreale · 🚨 Gore-Tex Tsuyu!"},
   {id:4,time:"10:00",txt:"🏃 Pacing: fondo aerobico puro · NO cronometro · goditi paesaggio · pioggia fine/nebbia EPICA"},
   {id:5,time:"12:00",txt:"📍 Km 10: Statua Tatsuko dorata emerge acqua · Leggenda: ragazza → drago maledetto · giovinezza eterna"},
   {id:6,time:"13:00",txt:"🏁 Fine corsa · rientro Katakurinohana · doccia rapida"},
   {id:7,time:"13:30",txt:"🥢 Kiritanpo pranzo · riso pressato spiedini cedro · miso dolce o Kiritanpo Nabe hot-pot · recupero post-20km!"},
   {id:8,time:"14:30",txt:"🚌 Bus locale → Nyuto Onsen · strada sale foresta · aria fresca · 🚨 Controlla orari rientro (corse RARE!)"},
   {id:9,time:"16:00",txt:"♨️ Nyuto Onsen kashikiri vasca privata · acqua vulcanica lattiginosa (sorgente capezzolo!) · 7 ryokan storici · Tsurunoyu più antico · tatuaggio OK · bosco silenzioso · gambe perfette"},
   {id:10,time:"18:30",txt:"🚌 Ultimo bus valle · 🚨 Orari ossessivi! · rientro Katakurinohana · cena meritata"},
   {id:11,time:"20:00",txt:"🛏️ Riposo · domani: grande traversata ferroviaria → Nagano!"},
 ],exp:[]},
...
{n:10,d:"06/06",dow:"Sab",c:"Tazawa → Nagano",j:"田沢湖→長野",p:1,sl:"1166 Backpackers Nagano",
 ...
 schedule:[
   {id:1,time:"07:30",txt:"🍳 Colazione + check-out · ultima vista lago indaco · gambe post-20km recovery mode"},
   {id:2,time:"09:00",txt:"🚄 Shinkansen Komachi Tazawako → Omiya 3h · 💡 Sfrutta: Minna no Nihongo N4 grammatica o revisione itinerario · campagna veloce · reset cerebrale"},
   {id:3,time:"12:00",txt:"🍱 Hub Omiya NON uscire tornelli! · Ecute Omiya decine banchi · EKIBEN CULTURE: bento da stazione da tutto Giappone (Kobe, Hokkaido) · tè verde freddo"},
   {id:4,time:"13:00",txt:"🚄 Hokuriku Shinkansen (Kagayaki/Hakutaka) → Nagano 1h · pranzo ekiben sul tavolino · paesaggio montuoso · 🎌 Nagano = Summer Wars Mamoru Hosoda!"},
   {id:5,time:"14:30",txt:"🎒 Arrivo Nagano · 1166 Backpackers · guesthouse leggendaria zaino · casa legno ristrutturata · staff accogliente · bancone reception/cucina = conversazione giapponese perfetta!"},
   {id:6,time:"15:30",txt:"⛩️ Via Omotesando → Zenkō-ji · gigante legno anomalia rara: non settario (tutte fedi buddiste) + accoglie donne! · mastodontico · fumo incensi perenne"},
   {id:7,time:"16:30",txt:"🌑 Okaidan Meguri sotto sala principale · scale → BUIO TOTALE ASSOLUTO · zero luci zero telefoni · mano destra muro · CHIAVE PARADISO serratura metallica · deprivazione sensoriale INTENSA"},
   {id:8,time:"18:30",txt:"🥢 Cena: Shinshu Soba · regno assoluto soba Nagano · alta quota acqua pura · fredda su setaccio bambù (Zaru Soba) · tempura verdure montagna · NO gara velocità!"},
   {id:9,time:"20:00",txt:"🍘 Snack rientro: Oyaki · gnocchi grano saraceno piastra · ripieni verdure (melanzane miso, nozawana) · street food locale"},
 ],exp:[]},
...
{n:11,d:"07/06",dow:"Dom",c:"Nagano (Jigokudani + Obuse)",j:"長野(地獄谷+小布施)",p:1,sl:"1166 Backpackers Nagano",
 ...
 schedule:[
   {id:1,time:"08:00",txt:"🎫 Nagano Station sotterranea Nagaden · Snow Monkey Pass (treno + bus + ingresso!)"},
   {id:2,time:"08:30",txt:"🚃 Nagaden Nagano → Yudanaka · 💡 Chicca: treni dismessi Tokyo/Odakyu anni '90 · viaggio nel tempo estetica ferroviaria!"},
   {id:3,time:"09:30",txt:"🚌 Bus Yudanaka → Kanbayashi Onsen · hike 2km (30min) bosco cedri · scarpe adatte (fango piogge!)"},
   {id:4,time:"10:15",txt:"🐒 Jigokudani Monkey Park · macachi giapponesi · senza neve: rocce/alberi · 🚨 NO fissare occhi (sfida!) · NO abbassarsi · zaino chiuso (ladri formidabili!)"},
   {id:5,time:"12:30",txt:"🚶 Rientro 2km bosco → bus Yudanaka Station"},
   {id:6,time:"13:30",txt:"🚃 TAPPA SEGRETA: Nagaden scendi a Obuse (metà strada)"},
   {id:7,time:"14:00",txt:"🏯 Obuse città Hokusai · strade lastricate · case legno scuro · Museo Hokusai-kan carri festival dipinti a mano · ultimi anni maestro"},
   {id:8,time:"15:30",txt:"🦅 Gansho-in Temple · soffitto sala principale: FENICE 30m² Hokusai 89 anni (1 anno prima morte!) · occhio ti segue ovunque"},
   {id:9,time:"16:30",txt:"🌰 Merenda: specialità castagne Kuri · Sakurai Kanseido o caffè · gelato castagna o Mont Blanc locale · recupero glicemico"},
   {id:10,time:"17:30",txt:"🚃 Nagaden rientro Nagano 30min"},
   {id:11,time:"19:00",txt:"🥩 Cena: Shinshu Beef · bestiame nutrito MELE (Nagano 1° produttore!) · Yakiniku/Teppanyaki · proteine altissima qualità"},
   {id:12,time:"21:00",txt:"🏠 1166 Backpackers · relax area comune legno · 📋 PREP: domani Kamikōchi cuore Alpi!"},
 ],exp:[]},
...
{n:49,d:"15/07",dow:"Mer",c:"Tokyo → Italia ✈️",j:"東京→🇮🇹",p:3,sl:"—",
 ...
 schedule:[
   ...
   {id:6,time:"",txt:"48 notti. Fine avventura. 🎌"},
 ],exp:[]},
];
