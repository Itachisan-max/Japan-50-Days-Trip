...
const GUIDA_CONDENSATA = [
  {
    n:1,
    data:"28/05",
    titolo:"L'Arrivo a Tokyo",
    alloggio:"Plat Hostel Keikyu Asakusa Karin - Tokyo (Asakusa)",
    highlights:[
      "09:10 - L'Arrivo",
      "10:30 - 🚨 Correzione Trasporto & Check-in",
      "13:30 - ⛩️ Asakusa",
      "15:00 - 🎌 Ochanomizu",
    ],
    note:[
      "💡 Tip Culinario: Prima o dopo il tempio, cerca il negozio Asakusa Kagetsudo. Fanno il Jumbo Melonpan artigianale, ...",
      "📸 Spot Fotografico: Affacciati dal ponte e abbi pazienza. C'è un punto in cui si incrociano tre treni (linee Marunouc...",
    ]
  },
  {
    n:2,
    data:"29/05",
    titolo:"Tokyo Ottimizzato",
    alloggio:"Plat Hostel Keikyu Asakusa Karin - Tokyo (Asakusa)",
    highlights:[
      "06:00 - 🐟 Tsukiji Outer Market (IL PESCE FRESCO)",
      "09:15 - 🚇 Spostamento verso Shibuya",
      "10:00 - 🏙️ Shibuya Sky",
      "12:00 - 🚇 Spostamento verso Nakano",
    ],
    note:[
    ]
  },
  {
    n:3,
    data:"30/05",
    titolo:"L'Incanto di Nikkō",
    alloggio:"Guest House KITOEDA - Nikko",
    highlights:[
      "06:00 - 🏃‍♂️ CORSA 2: Pista Oda Field (Yoyogi)",
      "07:30 - 🚃 Tobu Limited Express Kegon",
      "09:30 - Arrivo a Nikkō & Logistica",
      "10:00 - 🌉 Shinkyo Bridge",
    ],
    note:[
      "⚠️ Nota Logistica: Questo treno specifico della compagnia Tobu NON è coperto dal JR Pass",
      "💡 Hack per i Biglietti: Acquista i biglietti d'ingresso al Santuario Tōshō-gū direttamente alla stazione di Tobu-Nikko no...",
    ]
  },
  {
    n:4,
    data:"31/05",
    titolo:"L'Anima dei Samurai nel Tōhoku",
    alloggio:"YUMORI ONSEN HOSTEL - Fukushima",
    highlights:[
      "08:00 - 🚆 Spostamento verso il Tōhoku (La risalita)",
      "11:30 - 🎒 Arrivo ad Aizu-Wakamatsu & Logistica",
      "12:00 - 🌀 Sazaedo Temple (Monte Iimori)",
      "13:30 - 🥢 Pranzo Esplosivo (Sauce Katsudon)",
    ],
    note:[
      "💡 Hack per il JR Pass: Nella bozza originale c'erano \\"treni locali\\", ma se hai il JR Pass attivo, puoi usare lo Shinkans...",
    ]
  },
  {
    n:5,
    data:"01/06",
    titolo:"Spiriti Kitsune e la Città degli Alberi",
    alloggio:"Sendai Guest House Umebachi - Sendai",
    highlights:[
      "08:30 - 🚆 Spostamento verso il villaggio",
      "09:30 - 🦊 Zao Fox Village (Miyagi Zao Kitsune Mura)",
      "12:00 - 🚆 Rientro e Arrivo a Sendai",
      "14:00 - 🌳 Esplorazione di Jozenji-dori",
    ],
    note:[
      "💡 Tip Logistico: Se hai attivato il JR Pass, sfrutta lo Shinkansen Yamabiko che ci mette appena 15 minuti. Se usi ...",
      "🚨 Hack per il trasporto: Dimentica l'autobus. I bus dalla stazione di Shiroishi sono quasi inesistenti (ne passano un paio...",
    ]
  },
  {
    n:6,
    data:"02/06",
    titolo:"L'Ascesa a Yamadera e l'Estetica di Sendai",
    alloggio:"",
    highlights:[
      "08:00 - 🎒 Preparazione zaino",
      "08:30 - 🚃 Senzan Line",
      "09:30 - ⛩️ L'Attacco ai 1015 Gradini",
      "11:30 - 🌅 La Cima: Gododō",
    ],
    note:[
      "🚨 Controllo Materiale: Infila nello zaino il Gore-Tex perché la stagione Tsuyu non perdona. I gradini di pietra secolari...",
    ]
  },
  {
    n:7,
    data:"03/06",
    titolo:"Le Isole di Pini e il Tramonto sul Fiume",
    alloggio:"",
    highlights:[
      "09:00 - 🚃 Spostamento verso l'Oceano",
      "09:45 - 🚢 Crociera nella Baia di Matsushima",
      "11:00 - 🍵 Matcha con Vista (Chicca Aggiuntiva)",
      "11:45 - 🌉 Fukuura Bridge",
    ],
    note:[
    ]
  },
  {
    n:8,
    data:"04/06",
    titolo:"Tradizione, Granito e la Sfida della Soba",
    alloggio:"Tototo (盛岡の泊まれるたまり場) - Morioka",
    highlights:[
      "08:30 - 📦 Logistica vitale: Takkyubin",
      "09:30 - 🚄 Il Proiettile Verde",
      "10:30 - 🎒 Arrivo a Morioka",
      "11:00 - 🌸 Ishiwarizakura (Il Ciliegio Spacca-Roccia)",
    ],
    note:[
      "💡 Pratica Linguistica: Dovrai compilare il denpyo (il modulo di spedizione). Molti konbini ne hanno versioni con traduzi...",
    ]
  },
  {
    n:9,
    data:"05/06",
    titolo:"Il Lago Indaco e l'Acqua Lattiginosa",
    alloggio:"Katakurinohana - Semboku (Lago Tazawa)",
    highlights:[
      "08:00 - 🚄 Il Proiettile Rosso",
      "09:00 - 🎒 Arrivo e Drop Bagagli",
      "09:30 - 🏃‍♂️ RUN 1: Giro del Lago Tazawa (20.4 km)",
      "12:00 - 📍 La Statua di Tatsuko (Km ~10)",
    ],
    note:[
      "🚨 Tsuyu Alert: Indossa il Gore-Tex leggero. È molto probabile che tu debba correre sotto una pioggia fine o imme...",
    ]
  },
  {
    n:10,
    data:"06/06",
    titolo:"Il Grande Salto e la Chiave del Paradiso",
    alloggio:"",
    highlights:[
      "07:30 - 🍳 Colazione e Check-out",
      "09:00 - 🚄 Il Proiettile Rosso: Shinkansen Komachi",
      "12:00 - 🍱 Hub di Omiya: La cultura dell'Ekiben",
      "13:00 - 🚄 Verso le Alpi: Hokuriku Shinkansen",
    ],
    note:[
      "💡 Tip da Viaggio: Tre ore filate di Shinkansen sono un'enormità in Giappone. Sfrutta il tavolino, il sedile reclina...",
    ]
  },
  {
    n:11,
    data:"07/06",
    titolo:"I Macachi e il Ritiro di Hokusai",
    alloggio:"",
    highlights:[
      "08:00 - 🎫 Acquisto Pass e Partenza",
      "08:30 - 🚃 Treno Nagaden: Nagano → Yudanaka",
      "09:30 - 🚌 Bus & Hike nel bosco",
      "10:15 - 🐒 Jigokudani Monkey Park",
    ],
    note:[
    ]
  },
  {
    n:12,
    data:"08/06",
    titolo:"Le Alpi e il Cratere di Itomori",
    alloggio:"HOTEL Lafonteine Suwa - Suwa",
    highlights:[
      "07:30 - 🚃 Spostamento verso i Monti",
      "08:30 - 🚌 La Salita a Kamikōchi",
      "10:00 - 🏔️ Taisho Pond (L'Inizio dell'Hike)",
      "11:00 - 🌊 Kappabashi Bridge",
    ],
    note:[
      "📸 Spot Definitivo: Guardare il Lago Suwa dall'alto al tramonto è esattamente l'esperienza che ha ispirato il cratere...",
    ]
  },
  {
    n:13,
    data:"09/06",
    titolo:"Corsa sul Lago e Corsa contro il Tempo",
    alloggio:"Minshuku Kanjiya - Shirakawago",
    highlights:[
      "06:30 - 🏃‍♂️ RUN 2: Il Giro del Lago Suwa (16km)",
      "10:30 - ♨️ Recupero: Onsen Katakurakan",
      "12:30 - 🚃 Treno verso il Mar del Giappone",
      "15:30 - 🎒 Arrivo a Toyama & Sprint",
    ],
    note:[
    ]
  },
  {
    n:14,
    data:"10/06",
    titolo:"Dalla Nebbia all'Oro di Kanazawa",
    alloggio:"Kanazawa Share House GAOoo - Kanazawa",
    highlights:[
      "06:30 - 🌅 L'Alba Esclusiva",
      "08:30 - 🚌 Spostamento in Città",
      "10:00 - 📦 Il Ricongiungimento Logistico",
      "11:00 - 🌳 Kenroku-en",
    ],
    note:[
    ]
  },
  {
    n:15,
    data:"11/06",
    titolo:"Acque di Cristallo e Castelli nella Valle",
    alloggio:"Anshin Oyado Nagoya - Nagoya",
    highlights:[
      "07:30 - 🚃 Spostamento Logistico: Kanazawa → Gifu",
      "10:00 - 🚌 La Missione per lo Stagno di Monet",
      "11:30 - 🎨 Namonaki Ike (Stagno di Monet)",
      "13:30 - 🚌 Spostamento verso i Canali",
    ],
    note:[
    ]
  },
  {
    n:16,
    data:"12/06",
    titolo:"L'Underground di Nagoya e l'Archivio di Kyoto",
    alloggio:"",
    highlights:[
      "08:30 - 🎒 Sfratto e Logistica",
      "09:30 - 👾 Esplorazione Osu Shopping District",
      "11:30 - 🛍️ La Scorta Ghibli (Piano B)",
      "12:30 - 🥩 Pranzo Ignorante: Misokatsu",
    ],
    note:[
    ]
  },
  {
    n:17,
    data:"13/06",
    titolo:"L'Alba Vermiglia e i Fuochi della Cucina",
    alloggio:"",
    highlights:[
      "05:30 - ⏰ La Sveglia Brutale (Ma Necessaria)",
      "06:00 - ⛩️ Fushimi Inari-taisha",
      "10:00 - ☕ Colazione/Recupero post-scalata",
      "10:30 - 🏛️ Kiyomizu-dera & Le Strade Storiche",
    ],
    note:[
      "🚨 TAPPA OBBLIGATORIA: Tra queste case storiche in legno, vai da Mochi mochi per lo spettacolo live (artigiani pestano i...",
      "💡 Google Maps: [Mochi mochi](https://maps.google.com?q=Mochi%20mochi,%202%20Chome-208-14%20Kiyomizu,%20Higashiya...",
    ]
  },
  {
    n:18,
    data:"14/06",
    titolo:"Le 1200 Facce e l'Oro Riflesso",
    alloggio:"",
    highlights:[
      "07:00 - 🎍 Arashiyama: La Foresta di Bambù",
      "08:00 - ⛩️ Tenryu-ji e le Simmetrie",
      "09:00 - 🗿 Otagi Nenbutsuji (La Perla Nascosta)",
      "11:00 - 🎵 Kyoto Orgel-Dō",
    ],
    note:[
    ]
  },
  {
    n:19,
    data:"15/06",
    titolo:"L'Impatto con il Caos del Kansai",
    alloggio:"Guesthouse U-En Osaka - Osaka (Fukushima-ku)",
    highlights:[
      "10:00 - 🛍️ Ultime compere a Kyoto",
      "11:00 - 🚃 Lo Shinkaisoku (Special Rapid)",
      "12:00 - 🎒 Check-in Guesthouse U-En Osaka",
      "13:30 - 🏙️ Shinsekai: Retro-Futurismo",
    ],
    note:[
    ]
  },
  {
    n:20,
    data:"16/06",
    titolo:"USJ e la Pura Adrenalina",
    alloggio:"",
    highlights:[
      "08:00 - 🚃 Spostamento verso il Parco",
      "09:00 - 🎮 Super Nintendo World",
      "11:00 - 🎢 Le Attrazioni Anime a Tempo Limitato",
      "14:30 - ⚡ Wizarding World of Harry Potter",
    ],
    note:[
    ]
  },
  {
    n:21,
    data:"17/06",
    titolo:"Otaku Culture, Capibara e Preparativi",
    alloggio:"",
    highlights:[
      "10:00 - 🎌 Den Den Town: La Caccia",
      "12:00 - 🐾 ANIMEAL Cafe Shinsaibashi",
      "18:30 - 🎣 La Cena Sfida: ZAUO Fishing Restaurant Namba",
      "21:00 - 💼 PREPARAZIONE VAN: La Svolta Logistica",
    ],
    note:[
    ]
  },
  {
    n:22,
    data:"18/06",
    titolo:"Le Case sull'Acqua e la Prima Notte su Ruote",
    alloggio:"",
    highlights:[
      "08:30 - 🚐 Il Passaggio di Consegne",
      "09:30 - 🛒 Missione Sopravvivenza (Mega-Spesa)",
      "14:00 - 🌉 Amanohashidate (Il Ponte verso il Cielo)",
      "16:30 - 🚗 Strada Costiera verso Nord",
    ],
    note:[
    ]
  },
  {
    n:23,
    data:"19/06",
    titolo:"Dalle Grotte Marine al \"Sahara Giapponese\"",
    alloggio:"",
    highlights:[
      "10:00 - 🌊 Uradome Coast: L'Hike delle Scogliere",
      "14:00 - 🎨 The Sand Museum",
      "16:00 - 🏜️ Dune di Tottori (Tottori Sakyu)",
      "18:30 - 🦀 Cena al Porto",
    ],
    note:[
    ]
  },
  {
    n:24,
    data:"20/06",
    titolo:"Dai Manga al Legno Scuro dei Samurai",
    alloggio:"",
    highlights:[
      "10:00 - 🕵️ Conan Town (Hokuei)",
      "13:30 - 🏯 Il Castello di Matsue",
      "15:30 - 🛶 Horikawa Pleasure Boat",
      "17:30 - 🌅 Il Tramonto sul Lago Shinji",
    ],
    note:[
    ]
  },
  {
    n:25,
    data:"21/06",
    titolo:"La Cordigliera e la Piastra di Hiroshima",
    alloggio:"",
    highlights:[
      "08:00 - ⛩️ Izumo Taisha (Il Santuario degli Dei)",
      "11:00 - 🚗 Il Taglio di Honshu",
      "18:30 - 🏙️ Arrivo a Hiroshima & Il Tempio del Cibo",
      "21:00 - 🏕️ Database Sosta Notturna (A scelta dal Mood)",
    ],
    note:[
    ]
  },
  {
    n:26,
    data:"22/06",
    titolo:"Il Torii Galleggiante e il Mare di Seto",
    alloggio:"",
    highlights:[
      "08:30 - 🚗 Arrivo e Abbandono del Van",
      "09:00 - ⛴️ La Traversata (10 minuti)",
      "09:30 - ⛩️ Itsukushima Shrine (Alta Marea)",
      "11:00 - 🏔️ L'Ascesa al Monte Misen",
    ],
    note:[
    ]
  },
  {
    n:27,
    data:"23/06",
    titolo:"Vento Salmastro, Acque Cobalto e il Veleno nel Piatto",
    alloggio:"",
    highlights:[
      "06:30 - ☕ L'Alba sul Cruscotto",
      "08:30 - ⛩️ Motonosumi Shrine (Il Drago sulla Scogliera)",
      "11:30 - 🌉 Tsunoshima Bridge (L'Illusione Ottica)",
      "14:30 - 🚗 La Discesa verso il Confine",
    ],
    note:[
    ]
  },
  {
    n:28,
    data:"24/06",
    titolo:"La Pietra Spaccata, Sartoria Urbana e i Bassifondi",
    alloggio:"",
    highlights:[
      "08:00 - 🕳️ Il Salto Sottomarino (Kanmon Tunnel)",
      "09:30 - 🗡️ Shohachiman Shrine (La Reliquia nel Bosco)",
      "13:00 - 🏙️ L'Impatto con Fukuoka (Daimyo District)",
      "17:30 - 🏃‍♂️ CORSA 8: Ohori Park (La Pista sul Lago)",
    ],
    note:[
    ]
  },
  {
    n:29,
    data:"25/06",
    titolo:"Il Gigante di Bronzo e le Vere Origini del Sapore",
    alloggio:"",
    highlights:[
      "08:30 - 🗿 Nanzo-in (Il Peso del Metallo)",
      "11:30 - 🚗 Taglio verso le Pianure del Sud",
      "13:00 - 🚣 Yanagawa (Il Ritmo Sospeso)",
      "15:30 - 🍣 Il Piatto della Leggenda: Unagi no Seiro Mushi",
    ],
    note:[
    ]
  },
  {
    n:30,
    data:"26/06",
    titolo:"Pali nell'Acqua, Bronzo e Carne Cruda",
    alloggio:"",
    highlights:[
      "07:30 - ☕ L'Aria del Mattino e il Check delle Maree",
      "09:30 - 🌊 Nagabeta Seabed Road (Il Treno di Chihiro)",
      "12:00 - 🏴‍☠️ La Caccia al Tesoro: Jinbe e One Piece",
      "15:00 - 🏯 Kumamoto Castle (Le Cicatrici di Pietra)",
    ],
    note:[
    ]
  },
  {
    n:31,
    data:"27/06",
    titolo:"Cenere, Maiali Neri e il Cratere Fumante (KAGOSHIMA)",
    alloggio:"",
    highlights:[
      "07:30 - 🚗 L'Autostrada verso Sud",
      "10:30 - 🌋 L'Impatto con Kagoshima e il Sakurajima",
      "12:30 - ⛴️ Il Traghetto Vulcanico (Col Van)",
      "13:30 - 🪨 Arimura Lava Observatory",
    ],
    note:[
    ]
  },
  {
    n:32,
    data:"28/06",
    titolo:"Palme, Fiamme Nere e le Lanterne di Nishitachi",
    alloggio:"",
    highlights:[
      "07:30 - 🚗 Taglio Verso la Costa del Pacifico",
      "10:30 - 🌴 Aoshima e la Tavola del Lavandaio",
      "13:00 - 🍗 Calorie e Aceto: Il Chicken Nanban",
      "15:30 - ⛩️ Udo Jingu (Il Santuario nella Grotta)",
    ],
    note:[
    ]
  },
  {
    n:33,
    data:"29/06",
    titolo:"La Foresta degli Spiriti e la Gola di Smeraldo",
    alloggio:"",
    highlights:[
      "07:30 - ☕ Risveglio tra le Montagne",
      "09:00 - 🌿 Kamishikimi Kumanoimasu Shrine (Il Portale)",
      "11:30 - 🚗 Rientro in Prefettura di Miyazaki",
      "13:00 - 🥢 Pranzo: Nagashi Somen",
    ],
    note:[
    ]
  },
  {
    n:34,
    data:"30/06",
    titolo:"Corsa sul Cratere e le Terme Nascoste",
    alloggio:"",
    highlights:[
      "07:30 - 📱 Check Vulcanico e Partenza",
      "09:30 - 🌋 Kusasenri-ga-hama (La Corsa sull'Altopiano)",
      "11:30 - 🔥 Cratere Nakadake (Se Aperto)",
      "13:00 - 🚗 La Traversata del Kuju",
    ],
    note:[
    ]
  },
  {
    n:35,
    data:"01/07",
    titolo:"Il Giorno del Giudizio (HITA - ATTACK ON TITAN)",
    alloggio:"",
    highlights:[
      "08:00 - 🚗 Avvicinamento a Shiganshina",
      "09:30 - 🧱 Oyama Dam (La Disperazione dei Bambini)",
      "11:30 - 🖼️ Attack on Titan in HITA Museum (Annex)",
      "13:30 - 🥢 Pranzo: Hita Yakisoba",
    ],
    note:[
    ]
  },
  {
    n:36,
    data:"02/07",
    titolo:"Le Porte di Suzume, Crocchette e l'Inferno di Vapore",
    alloggio:"",
    highlights:[
      "07:30 - ☕ L'Uscita dalla Valle",
      "08:30 - 🚂 Bungo-Mori Roundhouse (La Porta verso l'Altrove)",
      "11:00 - 🚗 L'Arrampicata verso Yufuin",
      "11:45 - 🥩 Yunotsubo Street & Bungo Beef (L'Estetica dell'Onsen)",
    ],
    note:[
    ]
  },
  {
    n:37,
    data:"03/07",
    titolo:"Sangue, Pietra e l'Imbarco per lo Shikoku",
    alloggio:"",
    highlights:[
      "07:30 - ☕ L'Odore di Zolfo",
      "09:00 - 🔴🔵 Jigoku Meguri (I Sette Inferni di Beppu)",
      "11:30 - 🏖️ Beppu Kaihin Sand Bath (Sepolti Vivi)",
      "13:00 - 🚗 Taglio Verso Sud (Rotta per Usuki)",
    ],
    note:[
    ]
  },
  {
    n:38,
    data:"04/07",
    titolo:"Il Taglio delle Montagne e il Mercato del Fuoco",
    alloggio:"",
    highlights:[
      "07:30 - 🏰 L'Addio a Matsuyama",
      "12:30 - 🌊 Katsurahama Beach (Il Pacifico Selvaggio)",
      "15:00 - 🏯 Kochi Castle",
      "17:00 - 🏃‍♂️ CORSA 11: Pista Haruno Athletic Park (Tartan Blu)",
    ],
    note:[
    ]
  },
  {
    n:39,
    data:"05/07",
    titolo:"L'Extra Day: La Valle Nascosta dei Samurai (IYA VALLEY)",
    alloggio:"",
    highlights:[
      "08:00 - 🚗 Salita nell'Abisso Verde",
      "11:00 - 🌉 Iya Kazurabashi (Il Ponte di Liane)",
      "13:30 - 🍜 Pranzo: Iya Soba",
      "15:00 - 🚯 Il Bambino che fa Pipì (Peeing Boy Statue)",
    ],
    note:[
    ]
  },
  {
    n:40,
    data:"06/07",
    titolo:"Vortici Mortali e l'Isola di Awaji",
    alloggio:"",
    highlights:[
      "08:00 - 🚗 Discesa verso la Costa Est",
      "11:30 - 🌀 I Vortici di Naruto (Uzushio)",
      "14:00 - 🌉 L'Attraversamento dell'Onaruto Bridge",
      "15:30 - 🧅 Il Tramonto su Awaji",
    ],
    note:[
    ]
  },
  {
    n:41,
    data:"07/07",
    titolo:"Cemento Brutalista e il Rientro nel Kansai (NARA)",
    alloggio:"",
    highlights:[
      "08:30 - 🏛️ Tadao Ando's Water Temple (Honpukuji)",
      "11:00 - 🌉 Il Salto Finale: Akashi Kaikyo Bridge",
      "12:30 - 🚗 Bypass Urbano verso Nara",
      "14:30 - 🦌 Nara Park e l'Immensità di Legno",
    ],
    note:[
    ]
  },
  {
    n:42,
    data:"08/07",
    titolo:"Scarico Aerobico, Rientro e l'Ultima Notte a Osaka",
    alloggio:"",
    highlights:[
      "07:00 - 🏃‍♂️ Corsa all'Alba a Nara Park",
      "10:30 - 🧽 Check Logistico del Van",
      "12:00 - 🚗 La Discesa nel Gorgo: Osaka",
      "14:30 - 🏙️ Shimokitazawa del Kansai: Nakazaki-cho o Amerikamura",
    ],
    note:[
    ]
  },
  {
    n:43,
    data:"09/07",
    titolo:"Il Passaggio di Consegne e il Volo a Sud",
    alloggio:"Guest House Umikaji - Naha",
    highlights:[
      "08:30 - 🚐 La Fine dell'Asfalto",
      "09:30 - 🔑 Riconsegna del Mezzo",
      "10:30 - 🚉 Spostamento Verso l'Aeroporto",
      "12:30 - ✈️ Check-in e Pranzo Aeroportuale",
    ],
    note:[
    ]
  },
  {
    n:44,
    data:"10/07",
    titolo:"Il Salto nel \"Kerama Blue\"",
    alloggio:"Guest House Umikaji - Naha (Notte 2)",
    highlights:[
      "08:00 - 🚢 Il Porto di Tomari (Tomarin)",
      "10:00 - 🌊 Aharen Beach (L'Acqua Elettrica)",
      "16:30 - 🏃‍♂️ Scarico Aerobico sul Lungomare",
      "20:00 - 🥃 Il Rito dello Yuntaku in Terrazza",
    ],
    note:[
    ]
  },
  {
    n:45,
    data:"11/07",
    titolo:"Canne da Zucchero, Forni di Fango e Pollo all'Aglio",
    alloggio:"Guest House Umikaji - Naha (Notte 3)",
    highlights:[
      "08:30 - 🚌 Spostamento Verso Centro Isola: Yomitan Village",
      "10:30 - 🧱 Yachimun no Sato (Il Villaggio della Terra)",
      "13:00 - 🍜 Il Grasso Sacro: Sōki Soba",
      "15:30 - 🌴 Corsa a Cape Zanpa",
    ],
    note:[
    ]
  },
  {
    n:46,
    data:"12/07",
    titolo:"I Cervi Selvatici della Spiaggia Bianca",
    alloggio:"Guest House Umikaji - Naha (Notte 4 - ULTIMA)",
    highlights:[
      "08:00 - 🚢 Rotta per Aka Island (L'Isolamento)",
      "09:30 - 🦌 Nishibama Beach e i Cervi di Ryukyu",
      "16:30 - 🧱 I Muri di Pietra di Tsuboya",
      "20:00 - 🪕 L'Ultima Cena al Suono del Sanshin",
    ],
    note:[
    ]
  },
  {
    n:47,
    data:"13/07",
    titolo:"L'Ultimo Respiro di Oceano e il Ritorno a Kyoto",
    alloggio:"",
    highlights:[
      "08:00 - 🏃‍♂️ L'Ultima Sessione Tropicale",
      "09:30 - 🧽 Svuotamento Capsula e Check-out",
      "10:30 - 🛂 Aeroporto di Naha (OKA) & Check-in",
      "12:30 - 🛫 Volo GK352 - Decollo",
    ],
    note:[
    ]
  },
  {
    n:48,
    data:"14/07",
    titolo:"Il Gion Matsuri e lo Shinkansen della Morte",
    alloggio:"",
    highlights:[
      "09:30 - 🪵 L'Immensità dei Carri (Yamaboko)",
      "18:00 - 🏮 Il Delirio di Lanterne e Street Food",
      "21:00 - 🏃‍♂️ Lo Strappo e la Corsa alla Stazione",
      "21:38 - 🚄 L'Ultimo Treno per Tokyo (Nozomi 64)",
    ],
    note:[
    ]
  },
  {
    n:49,
    data:"15/07",
    titolo:"Il Gate e i Titoli di Coda",
    alloggio:"",
    highlights:[
      "05:00 - 🏃‍♂️ CORSA 14: Palazzo Imperiale (Il Giro d'Onore) - OPZIONALE",
      "06:30 - 🛂 Controllo Bagagli e Faccia da Zombie",
      "07:30 - ☕ L'Ultimo Tè Verde al Terminal 3",
      "08:45 - ✈️ Imbarco Gate",
    ],
    note:[
    ]
  },
...
function GuideView(){
  ...
  return(
    <div style={{maxWidth:900,margin:"0 auto",padding:"16px 12px"}}>
      <div style={{background:"white",borderRadius:8,padding:"20px",boxShadow:"0 2px 8px rgba(0,0,0,.08)",marginBottom:16}}>
        <h2 style={{margin:"0 0 8px",fontSize:24,fontWeight:900,color:"#1B4332"}}>
          📖 GUIDA DETTAGLIATA - 49 GIORNI
        </h2>
        <p style={{margin:"0",fontSize:14,color:"#666"}}>
          Programmi giornalieri, alloggi, highlights e note pratiche
        </p>
      </div>

      {GUIDA_CONDENSATA.map((g)=>{
        const isOpen = openDay === g.n;
        return(
          <div key={g.n} style={{background:"white",borderRadius:8,marginBottom:12,overflow:"hidden",boxShadow:"0 1px 4px rgba(0,0,0,.06)"}}>
            <div 
              onClick={()=>setOpenDay(isOpen ? null : g.n)}
              style={{
                padding:"16px",
                cursor:"pointer",
                background:isOpen?"#F0F7FF":"white",
                borderBottom:isOpen?"2px solid #1976D2":"none",
                transition:"all 0.2s"
              }}
            >
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <div>
                  <span style={{fontSize:13,fontWeight:800,color:"#1976D2",marginRight:8}}>G{g.n}</span>
                  <span style={{fontSize:12,color:"#666",marginRight:12}}>{g.data}</span>
                  <span style={{fontSize:15,fontWeight:700,color:"#333"}}>{g.titolo}</span>
                </div>
                <span style={{fontSize:18,color:"#1976D2"}}>{isOpen ? "▼" : "▶"}</span>
              </div>
            </div>
            ...
            {isOpen && (
              <div style={{padding:"20px",background:"#FAFAFA"}}>
                {g.alloggio && (
                  <div style={{marginBottom:20,padding:"12px",background:"#FFF3E0",borderLeft:"4px solid #FF9800",borderRadius:4}}>
                    <div style={{fontSize:12,fontWeight:800,color:"#E65100",marginBottom:4}}>🏠 ALLOGGIO</div>
                    <div style={{fontSize:13,color:"#333"}}>{g.alloggio}</div>
                  </div>
                )}

                {g.highlights.length > 0 && (
                  <div style={{marginBottom:20}}>
                    <div style={{fontSize:13,fontWeight:800,color:"#1976D2",marginBottom:12}}>⏰ HIGHLIGHTS PRINCIPALI</div>
                ...
                {g.note.length > 0 && (
                  <div>
                    <div style={{fontSize:13,fontWeight:800,color:"#D32F2F",marginBottom:12}}>💡 NOTE SPECIALI</div>
                    {g.note.map((n,i)=>(
                      <div key={i} style={{
                        padding:"12px",
                        background:"#FFF9C4",
                ...
                <div style={{marginTop:16,padding:"12px",background:"#E3F2FD",borderRadius:4,border:"1px solid #2196F3"}}>
                  <p style={{margin:0,fontSize:12,color:"#1565C0"}}>
                    📄 Per il programma orario completo e tutti i dettagli, consulta il file <strong>GUIDA-DETTAGLIATA.md</strong> nella repository GitHub
                  </p>
                </div>
              </div>
            )}
